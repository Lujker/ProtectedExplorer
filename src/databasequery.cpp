...
DatabaseQuery::RESULT DatabaseQuery::generate_create_files_table()
{
    ...
    QString str = "CREATE TABLE IF NOT EXISTS " + db::DatabaseAccessor::files_table + " ("
                    ...
                    "parentDir TEXT NOT NULL, isDir INTEGER NOT NULL, isShared INTEGER NOT NULL);";
...
DatabaseQuery::RESULT DatabaseQuery::generate_add_file(std::string& path)
{

}

DatabaseQuery::RESULT DatabaseQuery::generate_add_dir(std::string &path)
{
